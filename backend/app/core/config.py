...
class Settings(BaseSettings):
    ...
    JWT_SECRET_KEY: str = "ff3d-jwt-change-me-to-a-long-random-secret"
    JWT_ALGORITHM: str = "HS256"
    JWT_ACCESS_EXPIRE_MIN: int = 60 * 24 * 7  # 7일
    DEBUG: bool = True
    ...
    # 브라우저가 직접 접근하는 공개 주소 (presigned URL 서명에 사용)
    ...
    NERF_URL: str = "http://ff3d_nerf:8016"
    VIDEO_PROCESSOR_URL: str = "http://ff3d_video:8015"
    TRIPO_URL: str = "http://ff3d_tripo:8017"
    TWODGS_URL: str = "http://ff3d_twodgs:8018"
